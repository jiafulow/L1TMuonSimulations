...
ntupleSequence = cms.Sequence(ntupleEventInfo * ntupleGen * ntupleSim * ntupleDigi * ntupleHLT * ntupleReco * ntupleL1TMuon * ntupler)
#ntupleSequence = cms.Sequence(ntupleEventInfo * ntupleGen * ntupleSim * ntupleDigi * ntupleHLT * ntupleReco * ntupleL1TMuon * ntupleL1TMuonUnpacker * ntupler)
