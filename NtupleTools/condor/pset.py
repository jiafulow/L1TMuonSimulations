...
# with command line options: ntupleMC --step RAW2DIGI --mc --no_output --era Run2_2016 --conditions 80X_mcRun2_asymptotic_v6 --geometry=Extended2016,Extended2016Reco --customise L1Trigger/Configuration/customiseReEmul.L1TReEmulFromRAW --customise L1Trigger/Configuration/customiseUtils.L1TTurnOffUnpackStage2GtGmtAndCalo --customise L1TMuonSimulations/NtupleTools/customiseNtuple.cust_all --filein file:SingleMuon_PositiveEndCap.root --fileout file:SingleMuon_PositiveEndCap_ntuple.root --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ntupleMC nevts:1000'),
