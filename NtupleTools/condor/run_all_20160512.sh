...
# Condor jobs
python jobify.py NoAnalyzer SingleMuon_PositiveEndCap SingleMuon mu0 2016 80
...
python jobify.py NoAnalyzer SingleMuon_PositiveEndCap_100GeV SingleMuon mu0 2016 10
...
python jobify.py NoAnalyzer SingleMuon_PositiveEndCap_0T_100GeV SingleMuon mu0 2016 10

python jobify.py NoAnalyzer SingleNeutrino_PU30 SingleNeutrino nu30 2016 80
