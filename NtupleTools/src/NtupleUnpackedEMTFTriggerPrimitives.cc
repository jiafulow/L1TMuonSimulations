...
NtupleUnpackedEMTFTriggerPrimitives::~NtupleUnpackedEMTFTriggerPrimitives() {}

void NtupleUnpackedEMTFTriggerPrimitives::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
    ...
    if (stubs.isValid()) {
        ...
        *v_size = v_geoId->size();
        ...
        edm::LogError("NtupleUnpackedEMTFTriggerPrimitives") << "Cannot get the product: " << stubTag_;
    }
